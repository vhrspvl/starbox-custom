...
frappe.get_desktop_icons = function (show_hidden, show_global) {
    ...
    var show_module = function (module) {
        ...
        if (m.type === "page") {
            ...
            if (frappe.user.has_role('Employee') && m.module_name === 'Starbox Custom' || m.module_name === 'Accounts' || m.module_name === 'Website' || m.module_name === 'Contacts' || m.module_name === 'Projects') {
                out = false;
            }
            // else if (frappe.user.has_role('Employee') && m.module_name === 'Starbox Custom' || m.module_name === 'Accounts' || m.module_name === 'Website' || m.module_name === 'Contacts' || m.module_name === 'Projects') {
            //     out = false;
            // }
